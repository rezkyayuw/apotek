<div class="card">
	...
	<div class="card-body">
		<form action="<?php echo base_url('index.php/obat/index/') ?>" method="post">
			<div class="row">
				<div class="col-md-3">
			...
			<table class="table">
				...
				<?php foreach ($result as $data): ?>
					<tr>
						...
						<td>
							<a href="<?php echo base_url('index.php/obat/detail/'.$data['id_obat']) ?>" class="label label-info" >Edit</a>
							<a href="<?php echo base_url('index.php/obat/delete/'.$data['id_obat']) ?>" class="label label-danger" >Hapus</a></td>
					</tr>
					<?php $no++ ?>
				<?php endforeach ?>
			</table>
