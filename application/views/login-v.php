...
<head>
	...
	<!-- code $tittle diambil dari controller -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<!-- Perbedaan method post dan get. post tidak menampilkan username dan password di link, sedangkan get ditampilkan -->
					<form class="md-float-material form-material" action="<?php echo base_url('index.php/login/proses_login') ?>" method="post">
						<div class="text-center">
							 <img class="img-fluid" src="<?php echo base_url('assets/img/'.$perusahaan->logo) ?>" alt="Theme-Logo" width ="30px">&nbsp;<span class="text-light" style="font-size: 15px: "><?php echo $perusahaan->nama_perusahaan; ?></span>
						</div>
							...
							<div class="card-block">
								...
								<?php endif ?>
									...
									<div class="row m-t-30">
										<div class="col-md-12">
											<button type="su" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Sign in</button>
										</div>
									</div>

								<hr>
								<div class="text-center">2020 &copy; Copyright</div>
							</div>
						</div>
					</form>
					<!-- end of form -->
